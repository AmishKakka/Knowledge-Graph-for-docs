...
2. We are using [Neo4j](https://login.neo4j.com/u/login/identifier?state=hKFo2SBidm1uRlNXaUdLZVdMUmlzRGdiUkJpTGp6c3FhRWJCZ6Fur3VuaXZlcnNhbC1sb2dpbqN0aWTZIHdfYlhSeHBHSVZVa3IyakhOenFSUEJhQW9hSzFjT2Q3o2NpZNkgRXZ2MmNjWFBjOHVPeGV3bzBJalkyMFlJckg3VmtKVzk) for our graph systems.
Use the Dockerfile to create an image and then run it from your terminal or from Docker desktop. First ensure your Docker Desktop is up and running.

    This dockerfile sets up a Linux environment and installs neo4j.
    ...
    Now, you can run an interactive terminal for this container or just use the Docker Desktop to add, modify and run code.
